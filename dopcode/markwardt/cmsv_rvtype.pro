...
;
; $Id: cmsv_rvtype.pro,v 1.1.1.1 2003/06/12 21:43:41 johnjohn Exp $
;
;-
...
pro cmsv_rstructdesc, block, pointer, template, unit=unit, $
  ...
  inherits   = (buff(0) AND 2) NE 0  ;; This is a class, inherits from a super
  ...
  if inherits OR is_super then begin
