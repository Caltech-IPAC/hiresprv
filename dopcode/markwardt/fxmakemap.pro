...
;
;  $Id: fxmakemap.pro,v 1.1.1.1 2003/06/12 21:43:40 johnjohn Exp $
;
;-
...
@fxfilter
  ...
  if ct EQ 0 then begin
      ...
      nfilters = n_elements(filters)/2
      filters = reform(filters, 2, nfilters, /overwrite)
  endif else begin
      filters(*,wh) = [suffix, command]
  endelse
end
