...
;  CACHE_LEN   - for each cache LUN, the length of the cache in bytes.
...
;
;  $Id: fxpcommn.pro,v 1.1.1.1 2003/06/12 21:43:40 johnjohn Exp $
;
;-
...
;-
        COMMON FXPIPE_COMMON, POINTER, CACHE_UNIT, CACHE_LEN, CACHE_FILE, $
          BYTELENS, EOF_REACHED, PROCESS_ID
