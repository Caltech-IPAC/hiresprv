...
;
;  $Id: hprstatn.pro,v 1.1.1.1 2003/06/12 21:43:41 johnjohn Exp $
;
;-
...
pro hprstatn, jdtt, r_iers, r_eci, v_eci, tbase=tbase0, $
  ...
  hprnutang, jdtt, tbase=tbase0, zeta, theta, z, dpsi, deps, $
    jd_ut1=jdut1, mean_obliq=eps0, true_obliq=eps, $
    gms_time=gmst, gas_time=gast, eq_equinox=eqeq, $
    polar_x=pmx, polar_y=pmy, use_eop=use_eop, no_ut1=no_ut1, jpl=jpl
