...
;
; SIDE EFFECTS:
;       The color table may be modified.  If a window is not open,
;       a pixmap is created then destroyed to establish the visual
;       class and depth.  If the /TEST keyword is set and the device
;       is X Windows, window 28 is used to display the color table and 
;       line plot colors.
;
; RESTRICTIONS:
