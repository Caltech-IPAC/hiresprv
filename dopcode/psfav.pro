pro  psfav,vd,order,pixel,osamp,psf,nip $
            , accordion=accordion $
            , del_ord=del_ord $
            , del_pix=del_pix $
            , ghparam=ghparam  $
...
;
;KEYWORDS: 
;		kepler - keyword to be used on all Kepler stars. Uses median of a 7x7
;				 box of psfs as the final psf that is output. 2/2015 HTI.

; Versions: Originated somepoint in the late 20th century
;
;  Updates: 1/2015, HTI, GM, 
...
if keyword_set(kepler) then begin; Uses 7x7 grid and chooses median psf
 del_pix = 300	 ; default is 175
 del_ord = 3	 ; default is 1
endif
