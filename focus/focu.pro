...
!p.charsize=1.8
  titl = '!6HIRES THORIUM FOCUS LINES'
  yt='ROW #'
  xt='COL #'
 ; display,im(*,400:999),xs,ys,min=minim,max=500,titl=titl,ytit=yt,xtit=xt
  ...
  !p.charsize=1.3
ps_open,'thorium_boxes'
  display,im,xs,ys,max=500,titl=titl,ytit=yt,xtit=xt,/psfine
  oplot,x,y+2,ps=6,symsize=1.8,thick=5 ;boxes at LINE LOC's (+1 is kludge)
;  oplot,x,y+2,ps=8,co=300
;oplot,x,y+2,ps=6,symsize=1.8 ; at LINE LOC's (+1 is kludge)
;  oplot,x,y+2,ps=6,symsize=1.8 ;at LINE LOC's (+1 is kludge)
;loadct,13
;  oplot,x,y+2,ps=6,symsize=1.8
...
; print,format='(A25,A6)','      CCD Position =',strtrim(string(fix(focus)),2)
 ...
 print,'--------------------------------------'
 print,format='(A15,F8.3,A13)','AVG FWHM =  ',avgfwhmx,'   1.6 - 1.9 (HIRES)'
