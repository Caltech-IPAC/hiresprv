pro mkslitf, im, back, ymin, ycen, ymax, yslitf, slitf, sfunc, bincen, plot=plot, mask = mask, fwhm = fwhm
...
if n_params() lt 8 then begin
  print, 'syntax: mkslitf, im, back, ymin, ycen, ymax, yslitf, slitf, bincen [,/plot, mask=mask,fwhm=fwhm]'
  retall
endif
