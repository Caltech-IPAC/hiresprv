...
;middir_out = getenv("RAW_MID_OUT")
;reddir_out = getenv("RAW_RED_OUT")
bludir_out = getenv("RAW_ALL_OUT")
...
; Show directory and file names specifically.
print,'MAKE_HAMRED: Input log = ', logfile
print,'MAKE_HAMRED: :'

;file=1
;if keyword_set(file) then begin
outfile = outdir_hamred + 'hamred-'+run+'-'+night +'_b'
