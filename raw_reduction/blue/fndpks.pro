...
;31-May-05 JRL & GWM modified for blue
...
;Blue chip = 1 set of peaks
;pk = [678, 649, 621, 594, 567, 541, 517, 492] ;red ords
pk = [649, 621, 594, 567, 541, 517, 492]
pk =  [pk, 467,  443, 421, 398, 375, 354, 334, 313, 292]
;pk =  [pk, 273, 253, 234, 215, 197, 179, 161, 144, 127, 110]
pk =  [pk, 273, 253, 234, 215, 197,179,161]
pk =  reverse(pk)
