...
;05Nov-2009 GWM, HTI reset "sky", and overhauled how xwd is found. added decker kw
...
;stop
  ...
  xwd = fix(xwd+1.) + 1  ;round up and add 1. for safety
	if xwd lt 6 then xwd = 6 	;for safety sake, equals 6*0.38 = 2.8 arcseconds, gm and hi 5 nov 2009
  ...
  if decker ne 'C2' and decker ne 'B3' then begin
    if xwd gt 14 then xwd = 14   ; B1/ B5 can never be greater than this
      ...
      if xwd gt 20 then xwd = 14; This will catch outlyers for C2/B3
		; TEST low xwds here to find a better upper limit to the extraction wid.
