...
;Nov-17-01 JTW  Kludged to force scaling factor to 1:  intcon now does
;not alter the spectra at all except to put in the scaling factor for 
;so that downstream programs still recognize spectra.
;
@ham.common
;	
