...
;
; INPUT:
;    Reduced spectrum stored in /mir3/iodfits/ #now environment variable
;
; OUTPUT
;    Deblazed spectrum stored in /mir3/iodfitsdb/ #now environment variable
;
; EXAMPLE:
